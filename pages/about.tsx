...
const About: React.FC = () => {
  ...
  const imageVariant: Variants = {
    ...
    exit: { opacity: 0, x: 40, transition: { duration: 0.5, delay: 0.6 } }
  };
  ...
  return (
    <>
      <motion.div
        ...
        whileHover={{
          x: 20,
          transition: { type: 'spring', stiffness: 425, damping: 8 }
        }}
        variants={imageVariant}
        className="hidden md:block absolute top-20 left-40 w-[135px] h-[135px] z-10"
      >
      ...
      >
        ...
        <p className="mt-2 md:mt-3">
          ...
          sources. To reach this goal, I aim to consistently work on projects
          that can help diversify my thought process, enable me to learn
          different technologies, and further refine my{' '}
          <Link
            href="/skills"
        ...
        <p className="mt-2 md:mt-3">
          ...
          also enjoy reading the news, especially anything related to science
          and the international world, and keeping up with what&apos;s going on
          in the everchanging programming world.
        </p>
      </Section>
    </>
  );
